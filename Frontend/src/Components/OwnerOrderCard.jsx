...
function OwnerOrderCard({ order }) {
  ...
  console.log("CHECK:", { orderId, shopId, status });
  ...
  <div className='bg-white rounded-lg shadow p-4 space-y-4'>
    ...
    <div className='flex justify-between'>
      ...
      <span>
        ...
        <select className='pl-3 border-black shadow' onChange={(e) => handleUpdate(order.shops[0].shop._id || order?.shops?.[0]?.shop, e.target.value)}>
